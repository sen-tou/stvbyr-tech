...
In my previous post I showed you how you can {{< link target="_blank" text="use multiple Obsidian config folders and sync them with github" ref="/blog/use-multiple-Obsidian.md-config-folders-with-git.md" >}}.
...
- Sync our Obsidian vault automatically with the {{< link target="_blank" text="Obsidian Git plugin" href="https://github.com/denolehov/Obsidian-git" rel="external">}}
...
- Obsidian installed on at least one device
  - {{< link target="_blank" text="Obsidian Git plugin" href="https://github.com/denolehov/Obsidian-git" rel="external">}} installed 
...
I used {{< link target="_blank" text="this blog post by Andi Dittrich" href="https://andidittrich.de/2016/03/howto-re-enable-scpssh-login-on-Synology-dsm-6-0-for-non-admin-users.html" rel="external">}} to solve the problem. It's a little dated but still works for DSM 7.0.
...
Read this excellent {{< link target="_blank" text="tutorial by Aaron Lenoir" href="https://blog.aaronlenoir.com/2018/05/06/ssh-into-Synology-nas-with-ssh-key/" rel="external">}} if you want to know more. Essential parts are "Enable Public Key Authentication":
...
I am a bit lazy and don't want to copy paste everything, so use this tutorial for the {{< link target="_blank" text="Synology Git Server" href="https://kb.Synology.com/en-global/DSM/help/Git/git?version=7" rel="external">}} to create your repository and clone it to your client.
...
Follow my tutorial on how to {{< link target="_blank" text="use multiple Obsidian config folders and sync them with github" ref="/blog/use-multiple-Obsidian.md-config-folders-with-git.md" >}}.
